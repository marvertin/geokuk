...
/**  Bázová třída pro všechny výjimky, které bude vyhazovat Tw
 * nebo i TC aplikace. Jsou to kompilátorem nečekované výjimky.
 * Tato třída se liší od předka Exception v těchto bodech:
 *    1. Nemá konstruktor pr zřízení výjimky bez řetězce.
 *    2. Uchovává odkaz na předchozí výjimku, čímž vytváří zřetězený
 *       seznam výjimek a je možné při přehazování výjimek sledovat jejich stopu.
 *       metoda toString vrací informace o všech výjimkách v seznamu.
 *    3. Nová metoda getStackTrace vracející nejúplnější informace o výjimkce.
 *        (ve statické i instanční verzo)
 *    4. Nová metoda rethrow, která volající výjimku obalí výjimkou stejného typu.
 *        (ve statické i instanční verzi)
 *  @author Martin Veverka
 */
public abstract class YObject0 extends Exception
{
   ...
   * 
   */
  private static final long serialVersionUID = 5472071734782881120L;
     ...
     */
    public YObject0(String s, Exception e)
    {
        super(s, e);
    }
     ...
     * technicky a systémově znalé osobě.
     */
    public YObject0(Object trida, String s)
    {
     ...
     * @param e Přehazovaná výjimka.
     */
    public YObject0(Object trida, String s, Exception e)
    {
