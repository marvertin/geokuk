...
/**Předek všech elementárních typů založených na stringu.
 * Tento předek již deklaruje protektovanou stringovou instanční proměnnou iValue,
 * proto ji ve svých potomcích nemusíte (a neměli byste) deklarovat.
 * Neměli byste deklarovat žádné instanční proměnné. Pokud to potřebujete,
 * nepoužívejte tuto třídu jako předka.
 *
 * V následníku musíte udělat vždy konsteruktor, který naplní proměnnou iValue a
 * v případě potřeby provede patřičné testy správnosti. Vstupní parametr může
 * upravovat do kanonického tvaru.
 * Ostatní metody předefinováváte pouze v případě potřeby.
 *
 ...
 */
public abstract class AString0
extends AObject0
