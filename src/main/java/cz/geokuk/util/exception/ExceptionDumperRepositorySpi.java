...
public interface ExceptionDumperRepositorySpi {
	...
	/**
	 * Vrátí rozlišující číslo běhu aplikace. Výsledek z metody se zúčastní tvorby jednoznačné identifikace výjimky. V rámci jednoho ClassLoaderu mají všechny výjimky jednoznačně přiřazeno číslo. Aby se však zajistila jednoznačnost čísla výjimky v rámci celé repozitoře, je k dispozici tato metoda.
	 *
	 * @return Nějaké jednoznačné číslo, které je stejné pro danou JVM (classloader), ale musí se vzájemně a to i historicky lišit pro různé JVM.
	 */
