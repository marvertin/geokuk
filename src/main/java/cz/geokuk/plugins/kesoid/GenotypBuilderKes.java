...
class GenotypBuilderKes {
	...
	public void build(Kes kes) {
		...
		case ACTIVE:    g.put(genom.ALELA_actv); break;
		case DISABLED:  g.put(genom.ALELA_dsbl); break;
		case ARCHIVED:  g.put(genom.ALELA_arch); break;
		}
		switch (kes.getSize()) {
		case UNKNOWN:       g.put(genom.ALELA_00000); break;
		case NOT_CHOSEN:    g.put(genom.ALELA_nlist); break;
		case MICRO:         g.put(genom.ALELA_micro); break;
		case SMALL:         g.put(genom.ALELA_small); break;
		case REGULAR:       g.put(genom.ALELA_regul); break;
		case LARGE:         g.put(genom.ALELA_large); break;
		case VIRTUAL:       g.put(genom.ALELA_virtu); break;
		case HUGE:          g.put(genom.ALELA_hugex); break;
		case OTHER:         g.put(genom.ALELA_other); break;
		}
