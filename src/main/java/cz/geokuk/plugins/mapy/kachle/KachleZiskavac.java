...
public class KachleZiskavac {
	...
	private final PocitadloRoste pociChybDiskoveKese = new PocitadloRoste("ka24 DISK cache #chyb čtení", "Kolikrát selhalo čtení dlaždich z disku.");
	...
	private final PocitadloRoste pocitDownloadWeb = new PocitadloRoste("ka32 WEB #načtených", "Kolikrát se muselo hledanou flaždici stáhnout z webu a to úspěšně.");

	private final PocitadloRoste pocitChybDownloadWeb = new PocitadloRoste("ka33 WEB #chyb", "Kolikrát downloadování dlaždice zahlásilo chybu.");
