...
public class JObdelnik extends JComponent {
  ...
  protected void paintComponent(Graphics aG) {
    ...
    // Nakreslíme køíž vodorovný støedový
    ...
    // Zajístíme, že se bude otáèet kolem støedu
    g.translate(a/2, b/2);
  ...
  private void draw(Graphics2D g, Dvoj d) {
    // Nulový køíž, aï vidíme, kde je poèátek
  ...
  /**
   * Spoèítá veliksot obdélníku tak, aby nový obdélník
   * vešel do obdélníku daném zadanými stranami, když je pootoèen
   * o zadaný úhel.
   * @param uhel
   * @param a
   * @param b
