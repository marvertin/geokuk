...
import cz.geokuk.plugins.kesoid.JKesoidy;
...
import cz.geokuk.plugins.mrizky.JMeritkovnik;
...
public class JMainFrame extends JFrame implements SlideListProvider {
  ...
  public void init() {
...

    {
      ...
      final JComponent meritkovnik = new JMeritkovnik();
      ...
      final JComponent kesky = new JKesoidy();
  ...
  private JComponent createDetailRoh() {
    ...
    factory.init(mysovani);
    detailKachlovnik.setKachloTypes(new KaSet(EnumSet.of(EKaType.OPHOTO)));
    detailRoh.setBorder(BorderFactory.createEtchedBorder(EtchedBorder.RAISED));
    return detailRoh;
  }
