...
/**Rozhraní objektu, které funguje jako mapa čítačů. Lze si to představit jako mapa čítačů.
 * Jako klíč může být použit objekt libovolného typu, který má korektně definovánu metodu equals,
 * protože tato metoa se použie pro určení shodnosti klíčů. Typicky budou výčty řetězce, výčty, obálky primitivních typů,
 * může to být ale cokoli. Uživatel čítače musí mít na paměti, že některý z čítaných objektů bude mapou čítačů držen
 * do té doby, než čítač klesne k nule. Většina metod vrací hodnotu čítače před provedením operace.
 * Žádná operace nepřivede čítač do záporných hodnot. Pokud by operace k tomu vedla, zastaví se čítač na nule.
 *
