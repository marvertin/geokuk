...
public final class Dlg {
	...
	public static void warning(String informace) {
		JOptionPane.showMessageDialog(parentFrame(), informace, "Varování", JOptionPane.WARNING_MESSAGE);
	}

	public static void error(String informace) {
		JOptionPane.showMessageDialog(parentFrame(), informace, "Chyba", JOptionPane.ERROR_MESSAGE);
	}
