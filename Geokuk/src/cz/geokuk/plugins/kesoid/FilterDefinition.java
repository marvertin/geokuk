...
public class FilterDefinition implements Copyable<FilterDefinition> {
  ...
  /**
   * @param prahHodnoceni the prahHodnoceni to set
   */
  ...
  /**
   * @param prahBestOf the prahBestOf to set
   */
  ...
  /**
   * @param prahVyletu the prahVyletu to set
   */
  @PreferencebleIgnore
  ...
  /**
   * @param jenDoTerenuUNenalezenych the jenDoTerenuUNenalezenych to set
   */
  @PreferencebleProperty(name="jenFinal")
  ...
  /**
   * @param jenFinalUNalezenych the jenFinalUNalezenych to set
   */
  @PreferencebleProperty(name="jenJedenUNalezenych")
