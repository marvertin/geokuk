...
public class ImportBuilder {
  ...
  public ImportBuilder(String gccomNick, ProgressModel progressModel) {
  ...
  public void done (Genom genom) {
        ...
        if (wpt.getType() ==  EKesWptType.FINAL_LOCATION) {
          ...
          if (kesoid instanceof Kes) {
            ...
            if (Wpt.TRADITIONAL_CACHE.equals(kes.getFirstWpt().getSym())
              ...
              System.out.println("Vypouštíme finální waypointy tradičních keší na úvodních souřadnicích: " + kes.getNazev()
    ...
    //////////////////////////////////////
    System.out.println("Indexuji waypointy: " + delkaTasku);
    ...
    System.out.println("Konec zpracování: " + delkaTasku);
  }
  ...
  /**
   * @param outputForCache the outputForCache to set
   */
